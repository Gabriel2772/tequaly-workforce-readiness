    ...
    def overview(self) -> DataQualityOverview:
        ...
        issues = [
            DataQualityIssue(
                ...
                action="Completar e-mail, admiss�o, base e senioridade.",
            ),
            DataQualityIssue(
                code="employee_without_qualification",
                label="Pessoas sem qualifica��o registrada",
                count=without_qualification,
                severity="high" if without_qualification else "low",
                action="Confirmar a origem cadastral antes de planejar mobiliza��o.",
            ),
            DataQualityIssue(
                code="expired_qualification",
                label="Pessoas com qualifica��o vencida",
            ...
            DataQualityIssue(
                ...
                action="Completar custos antes de comparar cen�rios.",
            ),
            DataQualityIssue(
                code="operation_without_eligibility",
                label="Opera��es sem an�lise de elegibilidade",
